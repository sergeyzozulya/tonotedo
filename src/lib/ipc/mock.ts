...
const SCOPED_TAGS: Array<{ tag: string; scopePath: string; color: ChipColor; description?: string }> =
  [
    { tag: "atlas/blocked", scopePath: "work/atlas", color: "red", description: "Blocked item in Atlas project." },
    { tag: "atlas/shipped", scopePath: "work/atlas", color: "green", description: "Shipped in Atlas." },
